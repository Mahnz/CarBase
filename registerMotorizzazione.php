...
<head>
    ...
    <title>Registrazione motorizzazione</title>
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form action="registerValidation.php" method="POST" class="signup-form needs-validation" novalidate>
                                        ...
                                        if (strpos($URL, "signup=email") == true) {
                                            ...
                                            echo "<div class=\"alert alert-danger text-center\" role=\"alert\">" .
                                                ...
                                                "</div>";
                                        } else if (strpos($URL, "signup=password") == true) {
                                            echo "<div class=\"alert alert-danger text-center\" role=\"alert\">" .
                                                "Password non corrispondenti!" .
                                                "</div>";
                                        }
                                        ?>
                                        <input type="hidden" name="soggetto" value="motorizzazione">
                                        <div class="form-row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="initialism mb-1" for="inputNominativo">Nominativo</label>
                                            <input type="text" name="inputNominativo" id="inputNominativo" class="form-control" placeholder="Inserisci nominativo dirigente" required>
                                            <div class="invalid-feedback">Nominativo non inserito</div>
                                        </div>
                                        <hr />
                                ...
                                <div class="card-footer text-center">
                                    <div class="initialism">Sei gi&agrave; registrato? <a href="loginMotorizzazione.php">Accedi</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        function show(str, key) {
            ...
            if (key == 1) {
                if (str != "") {
                    ...
                    num_option = document.getElementById("inputCitta").options.length;
                    document.getElementsByName("inputCitta")[0].options[0].innerHTML = "Seleziona citt&agrave;...";
                    for (a = num_option; a >= 1; a--) {
                        document.getElementById("inputCitta").options[a] = null;
                    }
                    document.getElementById("inputCAP").value = "";
                    document.getElementById("inputProvincia").disabled = true;
                    document.getElementById("inputCitta").disabled = true;
                    document.getElementsByName("inputProvincia")[0].options[0].innerHTML = "Seleziona provincia...";
                    return;
                }
            } else if (key == 2) {
                if (str != "") {
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("inputCitta").innerHTML = this.responseText;
                        }
                    };
                    document.getElementById("inputCitta").disabled = false;

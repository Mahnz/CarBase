(function () {
	...
	if (typeof Date.dp_locales === 'undefined') {
		Date.dp_locales = {
			"texts": {
				"buttonTitle": "Seleziona data di nascita...",
				"buttonLabel": "Click or press the Enter key or the spacebar to open the calendar",
				"prevButtonLabel": "Mese precedente",
				"prevMonthButtonLabel": "Anno precedente",
				"prevYearButtonLabel": "w to the previous twenty years",
				"nextButtonLabel": "Mese successivo",
				"nextMonthButtonLabel": "Anno successivo",
				"nextYearButtonLabel": "",
				"changeMonthButtonLabel": "Click or press the Enter key or the spacebar to change the month",
				"changeYearButtonLabel": "Click or press the Enter key or the spacebar to change the year",
				"changeRangeButtonLabel": "",
				"closeButtonTitle": "Close",
				"closeButtonLabel": "Chiudi calendario",
...
(function(factory){
	...
	var datepickerButton3 = [
		...
		'	<span class="glyphicon glyphicon-calendar" title="Seleziona data..."></span>',
		'</a>'
	];
